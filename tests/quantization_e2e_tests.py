...
def rtol_95_percentile(actual: torch.Tensor, expected: torch.Tensor) -> numpy.floating:
...
class QUANTIZATION_E2E_CUDA_TESTS(unittest.TestCase):
    ...
    def test_qntz_dqntz_e2e_cuda_float16(self) -> None:
        is_a, do_pad = False, False
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float16, 4, 4, 0.011)

    def test_qntz_dqntz_e2e_cuda_float32(self) -> None:
        is_a, do_pad = False, False
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float32, 4, 4, 0.011)

    def test_qntz_dqntz_e2e_cuda_float64(self) -> None:
        is_a, do_pad = False, False
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float64, 4, 4, 0.013)

    def test_qntz_dqntz_is_a_e2e_cuda_float16(self) -> None:
        is_a, do_pad = True, False
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float16, 4, 4, 0.025)

    def test_qntz_dqntz_is_a_e2e_cuda_float32(self) -> None:
        is_a, do_pad = True, False
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float32, 4, 4, 0.022)

    def test_qntz_dqntz_is_a_e2e_cuda_float64(self) -> None:
        is_a, do_pad = True, False
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float64, 4, 4)

    def test_qntz_dqntz_do_pad_e2e_cuda_float16(self) -> None:
        is_a, do_pad = False, True
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float16, 4, 4, 0.011)

    def test_qntz_dqntz_do_pad_e2e_cuda_float32(self) -> None:
        is_a, do_pad = False, True
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float32, 4, 4, 0.011)

    def test_qntz_dqntz_do_pad_e2e_cuda_float64(self) -> None:
        is_a, do_pad = False, True
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float64, 4, 4, 0.013)
    ...
    def test_qntz_dqntz_is_a_do_pad_e2e_cuda_float32(self) -> None:
        is_a, do_pad = True, True
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float32, 4, 4, 0.022)

    def test_qntz_dqntz_is_a_do_pad_e2e_cuda_float64(self) -> None:
        is_a, do_pad = True, True
        self.qntz_dqntz_e2e_cuda(is_a, do_pad, torch.float64, 4, 4)

    def _test_qntz_mm_dqntz_e2e_cuda(
        self, dtype: torch.dtype, m: int, k: int, n: int
    ) -> None:
        # pyrefly: ignore [bad-argument-type]
        numpy.random.seed(0)
        torch.manual_seed(0)
    ...
    def test_qntz_mm_dqntz_add_e2e_cuda_float16(self) -> None:
    ...
    def test_qntz_mm_dqntz_add_e2e_cuda_float64(self) -> None:
